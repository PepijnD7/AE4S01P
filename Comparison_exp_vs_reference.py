...
plt.plot(t,T_test_list, label = 'Test data config II')
...
plt.legend()
plt.subplot(1,3,2)
plt.plot(t_Pc,Pc_test_list,label = 'Test data config II')
...
plt.grid()
plt.subplot(1,3,3)
plt.plot(t,Imp_test_list,label = 'Test data config II')
